...
const (
	...
	ironicHtpasswdVolume             = "ironic-htpasswd"          // #nosec G101
	inspectorHtpasswdVolume          = "inspector-htpasswd"       // #nosec G101
	ironicAgentPullSecretVolume      = "ironic-agent-pull-secret" // #nosec G101
	...
	ironicAgentPullSecretPath        = "/run/secrets"          // #nosec G101
	ironicHtpasswdPath               = "/etc/ironic"           // #nosec G101
	inspectorHtpasswdPath            = "/etc/ironic-inspector" // #nosec G101
)
...
var ironicAgentPullSecretMount = corev1.VolumeMount{
	Name:      ironicAgentPullSecretVolume,
